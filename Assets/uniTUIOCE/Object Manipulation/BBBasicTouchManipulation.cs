...
//		}
		...
		Vector3 screenPosition0 = new Vector3(touch.position.x,touch.position.y,zDistanceFromCamera);
		Vector3 lastScreenPosition0 = new Vector3(touch.position.x - touch.deltaPosition.x,touch.position.y - touch.deltaPosition.y,zDistanceFromCamera);
		Vector3 deltaPosition = screenPosition0 - lastScreenPosition0;
		float damping = 2;
		GameObject plane = GameObject.Find ("Plane");
		plane.transform.localRotation = Quaternion.Lerp(plane.transform.localRotation, Quaternion.Euler(plane.transform.localRotation.x + screenPosition0.y,plane.transform.localRotation.y, plane.transform.localRotation.z+ screenPosition0.x), damping);
